        ...
        <div className="about-container ac container  mx-auto px-5 lg:px-10 flex flex-col-reverse md:flex-row  items-start md:items-center justify-between gap-20">
          ...
          <div className="md:basis-1/2">
            ...
            <div>
              ...
              <p className="z-10 mb-2">
                Rafikihealth is a focused 8-week program that has been clinically proven to deliver
        ...
        <div className="about-cards container mx-auto px-5 lg:px-20 flex items-center md:items-start flex-col md:flex-row justify-between gap-10">
            ...
            >
              <g opacity="0.15">
                ...
                <circle
                  ...
                  strokeWidth="2.56954"
                />
                <circle cx="99" cy="-6" r="97" stroke="#F9FCFC" strokeWidth="2.56954" />
              </g>
            </svg>
            <span className="icon">
              <svg
          ...
          <div className="about-card w-80 md:w-[260px]">
            ...
            <span className="icon">
              ...
              >
                <path
                  d="M19.9471 19.646C18.2985 21.0339 16.1398 21.6599 14.0044 21.3693C13.8966 21.3548 13.7891 21.3979 13.7213 21.4829C13.6512 21.5715 13.6357 21.6916 13.681 21.7951L16.3912 27.6689C16.7265 28.5402 17.4839 29.1798 18.3991 29.3644C18.623 29.4102 18.8033 29.5762 18.8672 29.7957L19.3551 31.4666C19.4233 31.7022 19.5823 31.901 19.7972 32.0193C20.012 32.1377 20.2651 32.1657 20.5006 32.0974C20.5721 32.0758 20.6409 32.0461 20.7057 32.0089C21.0736 31.7957 21.249 31.3593 21.1309 30.9508L20.6454 29.2843C20.5816 29.0645 20.6447 28.8275 20.8095 28.6687C21.4825 28.0213 21.7782 27.075 21.5937 26.1595L20.4467 19.8186C20.4251 19.7122 20.3489 19.6251 20.2462 19.5897C20.1436 19.5542 20.0299 19.5756 19.9471 19.646Z"
                  fill="#06400B"
                />
                <path
                  d="M5.79943 10.9297L21.5489 6.34583C21.8613 6.25484 22.1118 6.0208 22.2238 5.71535C22.3359 5.40989 22.296 5.06938 22.1166 4.79801C19.785 1.30256 15.4553 -0.276356 11.421 0.897585C7.38657 2.07153 4.58004 5.72696 4.48792 9.92766C4.48174 10.2535 4.63104 10.5628 4.89001 10.7607C5.14898 10.9585 5.48667 11.0213 5.79943 10.9297Z"
                  fill="#06400B"
                />
                <path
                  d="M23.315 9.4664C23.0563 9.26817 22.7187 9.20497 22.4057 9.29621L6.66689 13.8739C6.35414 13.965 6.10338 14.1994 5.99151 14.5053C5.87965 14.8113 5.92003 15.1522 6.10028 15.4235C8.43271 18.9154 12.7599 20.492 16.792 19.319C20.8241 18.1459 23.6302 14.4941 23.7254 10.2959C23.7285 9.96983 23.5761 9.66178 23.315 9.4664Z"
                  fill="#06400B"
                />
              </svg>
            </span>
          ...
          <div className="about-card w-80 md:w-[260px]">
            ...
            <div className="card-text">
              <h2>85%</h2>
              <p>
                Of members with moderate to severe depression see symptom improvement after 6-16
                weeks
              </p>
            </div>
          </div>
          <div className="about-card w-80 md:w-[260px]">
            ...
            <div className="card-text">
              <h2>83%</h2>
              <p>
                Of members with moderate to severe anxiety see symptom improvement after 6-16 weeks*
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-5">
            <div>
              <div>
                ...
                <p>
                  Enjoy unlimited conversations with the AI assistant every time you need someone to
                  talk to witout waiting for therapist
                </p>
              </div>
              <h2 className="text-4xl font-bold">3 days</h2>
              <p>
                Enjoy appointment availability for your first therapist call within three days of
                signup.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                The average user spends nearly 20 hours interacting with their the AI

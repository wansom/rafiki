        ...
        <div className="flex  items-center justify-center container-fluid mx-auto px-5 border-b-[1px] border-solid border-black">
          ...
          <div className={isOpen ? "active links" : "hide links"} id="links">
            ...
            <button onClick={()=>{router.push('https://calendly.com/culturelyft/30min')}}
              ...
              <button 
                className=" flex items-center justify-center gap-2  px-4 py-2 text-sm font-medium leading-5 text-center text-[#01382E] transition-colors duration-150 border-[#01382E]  border-solid border-2 rounded-lg active:bg-[#01382E] hover:bg-[#01382E] hover:text-white focus:outline-none focus:shadow-outline-purple mx-3"
              >
               CREATE ACCOUNT<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
